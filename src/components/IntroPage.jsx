    ...
    <div className="intro-page">
      <div className="intro-card">
        ...
        <p>
          ...
          However, some of the images you will see are, in fact, synthetic! Your task is to select the one you think looks more realistic in each pair.
        </p>
        <p>
          <strong>What we collect:</strong> only your reponses for each pair of images, as well as information about your familiarity with plankton imaging and/or machine learning. 
          <br />
          <strong>What we do not collect:</strong> any names, emails, or other personally identifiable information.
        </p>
        <p>The survey should take you at most 20 minutes. You can pause at any time and return using the same URL. Please proceed only if you agree to the data collection policy outlined above. 
        ...
        <label className="consent-checkbox">
          ...
          />
          I agree to the data collection described above.
        </label>
